		...
		$target_dir = "../style/images/";
	            ...
	            if ($uploadOk == 0) {
	                ...
	                if (move_uploaded_file($_FILES["poto"]["tmp_name"], $target_file)) {
	                    ...
	                    echo "<script>alert('Sorry, there was an error uploading your file.');window.location = '?page=inpri';</script>";
	                    }
	                }

	    if ($syscl->upoto($nip,$target_file)) {
